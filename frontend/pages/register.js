...
export default function Register() {
  ...
  const roleLabel =
    form.role === "employer" ? "Employer" : "Candidate";
  ...
  return (
    <>
      ...
      <div className="flex min-h-screen flex-col bg-gradient-to-br from-slate-900 via-slate-950 to-slate-800">
        ...
        <section className="w-full max-w-md rounded-2xl bg-slate-900/80 p-6 shadow-2xl ring-1 ring-slate-700/70 backdrop-blur">
          <div className="mb-6">
            ...
            <div className="space-y-1">
              ...
              <div className="relative">
                ...
                <button
                  ...
                  className="absolute inset-y-0 right-0 flex items-center justify-center rounded-r-lg bg-slate-900/40 px-3 text-slate-100 hover:text-white cursor-pointer focus:outline-none focus-visible:ring-2 focus-visible:ring-emerald-500/80"
